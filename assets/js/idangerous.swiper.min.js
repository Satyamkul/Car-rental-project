...
var Swiper = function (a, b) {
      ...
      (c.onload = function () {
        C && void 0 !== C.imagesLoaded && C.imagesLoaded++,
          C.imagesLoaded === C.imagesToLoad.length &&
            (C.reInit(), b.onImagesReady && C.fireCallback(b.onImagesReady, C));
      }),
        (c.src = a);
    }
  ...
  function u(a, c, d) {
    function e() {
      ...
      (h += (i * l) / (1e3 / 60)),
        (k = "toNext" === j ? h > a : a > h),
        k
          ? (C.setWrapperTranslate(Math.round(h)),
            (C._DOMAnimating = !0),
          ...
          : (b.onSlideChangeEnd &&
              ("to" === c
                ? d.runCallbacks === !0 && C.fireCallback(b.onSlideChangeEnd, C)
                : C.fireCallback(b.onSlideChangeEnd, C)),
  ...
  function y(a) {
    for (
      var b, c = a.target || a.srcElement, d = C.paginationButtons, e = 0;
      e < d.length;
      e++
    )
      c === d[e] && (b = e);
          ...
          if ((a && C.calcSlides(c), "auto" === b.slidesPerView)) {
            ...
            for (
              f = M ? C.width / b.slidesPerView : C.width,
                ...
                b.cssWidthAndHeight ||
                  (parseFloat(i) > 0 && (m.style.width = i + "px"),
                  parseFloat(j) > 0 && (m.style.height = j + "px")),
                k = 0,
                C.snapGrid = [],
                C.slidesGrid = [],
                l = 0;
              ...
              C.snapGrid.push(k),
                ...
                (k += E),
                b.cssWidthAndHeight ||
                  (parseFloat(f) > 0 && (C.slides[l].style.width = f + "px"),
