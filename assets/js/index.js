...
(function ($, window, document, undefined) {
    ...
    $(".datetimepicker").datetimepicker({
      i18n: {
        de: {
          ...
          dayOfWeek: ["Sun.", "Mon", "Tues", "Wed", "Thru", "Fru", "Sat."],
        },
      },
      timepicker: false,
  ...
  $(".reservation .wheel-start-form label.promo button").on(
    "click",
    function (event) {
      event.preventDefault();
  ...
  $(".wheel-collection").on("click", ".wheel-collection-item", function () {
    ...
    $(this)
      ...
      .find(".wheel-collection-item")
      .removeClass("active-car");
  ...
  $(".tabs-header").on("click", "li:not(.active)", function () {
    ...
    swipers[
      "swiper-" +
        $(this)
          .closest(".wheel-collection ")
          .find(".tabs-item.active .swiper-container")
          .attr("id")
    ].reInit();
    sliderOpacity();
    var index_el = $(this).index();
    $(this)
      .closest(".wheel-our-menu")
      .find(".tabs-item")
      .removeClass("visible-swiper")
      .hide()
      .eq(index_el)
      .fadeIn(700)
  ...
  $(".swiper-outer-left").on("click", function () {
    swipers[
      "swiper-" + $(this).parent().find(".swiper-container").attr("id")
    ].swipePrev();
  });
  ...
  var $first_child_link = $(".menu-item-has-children > a").append(
  ...
  $first_child_link.find("span").on("click", function (e) {
    ...
    self
      .closest("li")
      .siblings(".menu-item.menu-item-has-children")
      .removeClass("active")
  ...
  var counters = function () {
    ...
    if (elemSize.length) {
      if (
        $(window).scrollTop() >=
        elemSize.offset().top - $(window).height() * 0.7
      ) {
  ...
  wpc_add_img_bg2(
    ".wheel-news-item2 .wheel-news-item-img img",
